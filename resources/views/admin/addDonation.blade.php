...
@section('content')
    <div class="wrapper container">
        <form action="{{ route('addDonation') }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row" style="margin-top: 2rem">
                <div class="col-md-12">
                    ...
                    <textarea name="payer_comment" id="payer_comment" cols="30" rows="5" class="form-control"></textarea>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 2rem">
                <div class="col-md-4">
                    ...
                    <input type="number" id="paid_amount" name="paid_amount" class="form-control"
                           placeholder="Сума внеску" required>
                </div>
            ...
            <div class="row" style="margin-top: 2rem">
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary">Добавити пожертву</button>
                </div>
            </div>
        </form>
    </div>
