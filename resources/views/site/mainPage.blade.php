                                ...
                                <div class="item">
                                    <div class="con">
                                        ...
                                        <div class="wrapper_item">
                                            <a href="{{route('singleProject', ['project' => $project->id])}}">Детальніше<i class="far fa-eye"></i></a>
                                        </div>
...
{{--                            </span>--}}
                                    ...
                                    <div class="bot-part">
                                        ...
                                        <div class="total-pay">
                                            зібрано {{$project->paid_amount}} $
                                        </div>

                                        <div class="progressbar">
                                            <div class="counter">{{round($project->paid_amount * 100 / $project->full_amount)}}%</div>
                                            <div class="bar">
                                                <div class="readystate" style="right: calc(100% - {{round($project->paid_amount * 100 / $project->full_amount) . '%'}});"></div>
                                            </div>
                                        </div>
                                        <div class="siders">
                                            <div class="peoplels">
                                            ...
                                            <div class="timer">
                                                ...
                                                <div class="count">
                                                    <strong>{{date_diff(new DateTime(), new DateTime($project->deadline))->format('%r%a днів')}}</strong>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
